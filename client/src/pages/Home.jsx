...
const Home = () => {
  ...
  useEffect(() => {
    const fetchPosts=async()=>{
      setloading(true)
      try {
        fetch('https://nervous-ray-swimsuit.cyclic.app/api/v1/post',{
            method:'GET',
            headers:{
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className='font-medium text-[#bada55] md:text-xl text-md italic'>"Let the world see your creativity"</p>
